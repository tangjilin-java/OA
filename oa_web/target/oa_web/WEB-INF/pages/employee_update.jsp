                ...
                <form:form action="${pageContext.request.contextPath}/employee/update" modelAttribute="employee"  id="admin-form" name="addForm">
                    ...
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="name" class="field prepend-icon">
                                    <form:input path="sex" class="gui-input" placeholder="性别..."/>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="sn" class="field prepend-icon">
                                    <form:input path="hometown" cssClass="gui-input" placeholder="籍贯..."/>
                                </label>
                            </div>
                            <div class="col-md-6">
                                <label for="name" class="field prepend-icon">
                                    <form:input path="tel" class="gui-input" placeholder="联系方式..."/>
                                </label>
                            </div>
                        </div>
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="sn" class="field prepend-icon">
                                    <form:input path="description" cssClass="gui-input" placeholder="自我描述..."/>
                                </label>
                            </div>
                        </div>
