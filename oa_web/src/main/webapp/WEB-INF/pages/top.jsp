...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/assets/img/100.ico">
...
<div id="main">
    <header class="navbar navbar-fixed-top navbar-shadow">
        <div class="navbar-branding">
            <a class="navbar-brand" href="${pageContext.request.contextPath}/self">
                <b>汤氏</b>OA公务报销
            </a>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="${pageContext.request.contextPath}${sessionScope.employee.pic}" alt="avatar" class="mw30 br64">
        ...
        <div class="sidebar-left-content nano-content">
            <header class="sidebar-header">
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#"><%--${pageContext.request.contextPath}/assets/img/avatars/4.jpg--%>
                            <img src="${pageContext.request.contextPath}${sessionScope.employee.pic}" class="img-responsive">
                        </a>
